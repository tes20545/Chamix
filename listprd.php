...
$query_prd = "SELECT * FROM tbl_prd ORDER BY p_id DESC";
...
<a href="product-detail.php?id=<?php echo $row_prd['p_id'];?>&act=product-detail"><img src="pmi/<?php echo $row_prd['images'];?>" width="80%" />
  <p align="center">
