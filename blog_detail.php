...
.caption {
    ...
    <div class="thumbnail text-center">
        <img src="assets/img/hero/category.jpg" alt="" class="img-responsive" width="100%">
        <div class="caption">
            <p><h2><b><font face="Kanit"><?php echo $row_prdt['c_name']; ?></font></b></h2></p>
        </div>
    </div>
<br>
<br>
 ...
 <div class="container">
 	<div class="row">
        <!-- product-->
        <div class="col-md-12">
         	<?php  include('blog_detail_info.php');?>
        </div>
