   ...
   <div class="panel panel-default">
    ...
    <div class="panel-body">
     <div class="table-responsive">
      <table id="type_product" class="table table-bordered table-striped table-hover">
       <thead>
        <tr>
         <td>ID</td>
         <td>Name</td>
...
$(document).ready(function(){
 ...
 var dataTable = $('#type_product').DataTable({
  "processing":true,
  "serverSide":true,
  "order":[],
  "ajax":{
   url:"prd_type_view.php",
   type:"POST"
  },
  "columnDefs":[
   {
 ...
 $(document).on('click', '.view', function(){
  ...
  new Dialogify('prd_type_view_single.php', options)
