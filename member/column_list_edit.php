...
$query = "SELECT * FROM tbl_column ORDER BY c_id ASC" or die("Error:" . mysqli_error($query));
...
//$i=1;
 while ($row = mysqli_fetch_array($result)) {
 	...
 	echo "<td>" ."<img src='images/column/".$row["c_img"]."'width='100'>". "</td>";
 	//Edit data
 	echo "<td><a href='column.php?ID=$row[0]&act=edit2' class='btn btn-success btn-xs'>แก้ไข</a>
</td>";
    echo "</tr>";
 $i++;}
 echo "</table>";
