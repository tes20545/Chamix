                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="column.php">ข้อมูล</a>
                            </li>
                            <li class="nav-item active">
                                <a class="nav-link" href="column.php?act=edit">แก้ไข</a>
                            </li>
                            <li class="nav-item active">
                                <a class="nav-link" href="column.php?act=rep">ลบ</a>
                            </li>
                            <li class="nav-item active">
                ...
                <div class="col">
                        <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal"><div class="card-body">
                              ...
                              <p class="card-text"><font color="white">เพิ่มบทความ</font></p>
                            </div>
                          </div>
                       </button>
                    </div>
                    <div class="col">
                        <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
                            <a href="column.php?act=edit" type="button" class="btn btn-primary"><div class="card-body">
                    ...
                    <div class="col">
                        <div class="card text-white bg-danger mb-3" style="max-width: 18rem;">
                            <a href="column.php?act=rep" type="button" class="btn btn-danger"><div class="card-body">
...
if ($act=='add') {
    include('column_add.php');
}elseif ($act=='edit') {
    include('column_list_edit.php');
}elseif ($act=='edit2') {
    include('column_edit.php');
}elseif ($act=='rep') {
    include('column_list_rep.php');
}
else{
    include('column_list_td.php');
}
?>
    </div>
<!--modal memberadd -->
